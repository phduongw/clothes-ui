            ...
            { data && (
                <div className={'w-[1200px] flex justify-start items-center al mt-12 gap-3'}>
                    <div className={'flex gap-6 w-[50%]'}>
                        ...
                        { displayImages && <Image src={displayImages} alt={data.name} width={0} height={0} className={'flex-1 h-auto'} unoptimized priority /> }
                    ...
                    <div className={'self-start'}>
                        ...
                        <div className={'mt-8 w-[700px] flex flex-wrap gap-3'}>
                            <SpecificationItem title={'Screen size'} info={data.specification.screenSize.toString()}>
                            ...
                            <SpecificationItem title={'Number of Cores'} info={data.specification.coreCpu.toString()}>
                            ...
                            <SpecificationItem title={'Front camera'} info={data.specification.frontCamera.toString()}>
                                <IoCameraReverseSharp className={'text-xl'} />
                            </SpecificationItem>
                            <SpecificationItem title={'Battery capacity'} info={data.specification.batteryCapacity.toString()}>
