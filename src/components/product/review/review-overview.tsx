...
const ReviewOverview: FC<{ reviews?: IReviewProduct }> = ({ reviews }) => {
    ...
    const level = [{
        levelName: 'Excellent',
        percentRating: totalReview && reviews ? reviews._5.length / totalReview * 100 : 0,
    }, {
        levelName: 'Good',
        percentRating: totalReview && reviews ? reviews._4.length / totalReview * 100 : 0,
    }, {
        levelName: 'Average',
        percentRating: totalReview && reviews ? reviews._3.length / totalReview * 100 : 0
    }, {
        levelName: 'Below Average',
        percentRating: totalReview && reviews ? reviews._2.length / totalReview * 100 : 0
    }, {
        levelName: 'Poor',
        percentRating: totalReview && reviews ? reviews._1.length / totalReview * 100 : 0
    }];
